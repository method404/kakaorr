...
type WeekdaySeriesBrowserProps = {
  filterItems: Array<{ key: KakaoSeriesFilter; label: string }>;
  locale: Locale;
        ...
        <div className="weekday-filter-bar">
          ...
          <div className="weekday-filter-list">
            {filterItems.map((item) => (
              <Link
                key={item.key}
                href={`/series/weekday?filter=${item.key}`}
                ...
                {section.items.map((item) => {
                  ...
                  const cardContent = (
                    <>
                      ...
                      <div className="weekday-tile-meta">
                        <div className="weekday-tile-author">
                          {item.author || "-"}
                        </div>
                        <div className="weekday-tile-submeta">
